...
local WeaponsFile = import('/mods/M&B/lua/BlackOpsweapons.lua')
...
BAL0401 = Class(AWalkingLandUnit) {
	...
	ChargeEffects01 = {
        '/mods/M&B/effects/emitters/g_laser_flash_01_emit.bp',
        '/mods/M&B/effects/emitters/g_laser_muzzle_01_emit.bp',
    },
    ChargeEffects02 = {
        '/mods/M&B/effects/emitters/g_laser_charge_01_emit.bp',
    },
    ChargeEffects03 = {
        '/mods/M&B/effects/emitters/g_laser_flash_01_emit.bp',  #glow
        '/mods/M&B/effects/emitters/g_laser_muzzle_01_emit.bp',  # sparks
    },
    Weapons = {
        BoomWeapon = Class(CDFLaserHeavyWeapon){
			...
			CreateProjectileForWeapon = function(self, bone)
				...
				for i = 0, (numProjectiles -1) do
					...
					CreateAttachedEmitter(self.unit, 'Bombard', self.unit:GetArmy(), '/effects/emitters/destruction_explosion_concussion_ring_03_emit.bp'):ScaleEmitter(0.16)
				end
			end,
        },
    ...
    OnStopBeingBuilt = function(self,builder,layer)
		...
		table.insert( self.MaelstromEffects01, CreateAttachedEmitter( self, 'Spinner_Rack', self:GetArmy(), '/mods/M&B/effects/emitters/inqu_glow_effect03.bp' ):ScaleEmitter(0.7):OffsetEmitter(0, -2.1, 0) )
		table.insert( self.MaelstromEffects01, CreateAttachedEmitter( self, 'Spinner_Rack', self:GetArmy(), '/mods/M&B/effects/emitters/inqu_glow_effect01.bp' ):ScaleEmitter(3):OffsetEmitter(0, 0, 0) )
		table.insert( self.MaelstromEffects01, CreateAttachedEmitter( self, 'Spinner_Rack', self:GetArmy(), '/mods/M&B/effects/emitters/inqu_glow_effect02.bp' ):ScaleEmitter(3):OffsetEmitter(0, 0, 0) )
    end,
    ...
    DeathThread = function( self, overkillRatio , instigator)
		...
		self:CreateProjectileAtBone('/mods/M&B/effects/entities/InqDeathEffectController01/InqDeathEffectController01_proj.bp', 'Body'):SetCollision(false)
