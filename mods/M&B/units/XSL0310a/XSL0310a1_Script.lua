...
local xsl0310a_LightningWeapon = import('/mods/M&B/lua/M&Bweapons.lua').xsl0310a_LightningWeapon
...
XSL0310a = Class(SWalkingLandUnit) {
    ...
    OnMotionHorzEventChange = function(self, new, old) 
        ...
        if not self.Dead and new != old then
    ...
    SpawnFlyingBot = function(self)
       if not self.Dead then  
           ...
           while not self.Dead and self.MotionStatus != 'Stopped' and self.MotionStatus != nil  do          
               WaitSeconds(0.1)
           end                    
