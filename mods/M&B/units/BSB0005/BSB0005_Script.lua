...
local SeraLambdaFieldRedirector = import('/mods/M&B/lua/BlackOpsdefaultantiprojectile.lua').SeraLambdaFieldRedirector
local SeraLambdaFieldDestroyer = import('/mods/M&B/lua/BlackOpsdefaultantiprojectile.lua').SeraLambdaFieldDestroyer
