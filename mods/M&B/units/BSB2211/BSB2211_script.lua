...
local SeraMineExplosion = import('/mods/M&B/lua/BlackOpsweapons.lua').SeraMineExplosion
local SeraMineDeathExplosion = import('/mods/M&B/lua/BlackOpsweapons.lua').SeraMineDeathExplosion
