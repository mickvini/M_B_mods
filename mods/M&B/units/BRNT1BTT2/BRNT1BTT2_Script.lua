	    ...
	    FxGroundEffect = EffectTemplate.ConcussionRingLrg01,
	        ...
	        PlayFxMuzzleSequence = function(self, muzzle)
	            ...
	            for k, v in self.FxVentEffect3 do
                    CreateAttachedEmitter(self.unit, 'BRNT1BTT2', army, v):ScaleEmitter(0.8)
                end
  	            for k, v in self.FxMuzzleEffect do
                    CreateAttachedEmitter(self.unit, 'Turret_Muzzle', army, v):ScaleEmitter(2.11)
                end
  	            for k, v in self.FxMuzzleEffect do
                    CreateAttachedEmitter(self.unit, 'Turret_Muzzle2', army, v):ScaleEmitter(2.11)
                end
...
CreatTheEffectsDeath = function(self)
	...
	for k, v in ModEffectTemplate['UEFDeathSML01'] do
		CreateAttachedEmitter(self, 'BRNT1BTT2', army, v):ScaleEmitter(0.6)
	end
end,
}
