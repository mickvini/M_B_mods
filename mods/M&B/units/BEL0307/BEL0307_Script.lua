...
local RailGunWeapon = import('/mods/M&B/lua/BlackOpsweapons.lua').RailGunWeapon01

local TIFCruiseMissileUnpackingLauncher = import('/lua/terranweapons.lua').TIFCruiseMissileUnpackingLauncher

local JuggLaserweapon = import('/mods/M&B/lua/BlackOpsweapons.lua').JuggLaserweapon

local JuggPlasmaGatlingCannonWeapon = import('/mods/M&B/lua/BlackOpsweapons.lua').JuggPlasmaGatlingCannonWeapon
