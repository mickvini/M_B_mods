...
BRA0309 = Class(CAirUnit) {
    ...
    OnStopBeingBuilt = function(self,builder,layer)
        ...
        --M&B: preset the cloak drain amount so the first toggle-on already pays 2500
        self:SetEnergyMaintenanceConsumptionOverride(2500)
...
#        self.AnimManip:PlayAnim(self:GetBlueprint().Display.AnimationTakeOff, false):SetRate(1)
    ...
    --M&B: cloak field toggle - while enabled the transport burns
    --2500 energy per second (user balance), toggled off = free
