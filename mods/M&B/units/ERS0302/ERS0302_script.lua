...
local WeaponsFile = import('/mods/M&B/lua/EXBlackOpsweapons.lua')
...
local HailfireLauncherWeapon = import('/mods/M&B/lua/EXBlackOpsweapons.lua').HailfireLauncherWeapon
...
ERS0302 = Class(CSeaUnit) {
    ...
    TransformThread = function(self, land)
        ...
        if( land ) then
            ...
            self:SetCollisionShape( 'Box', bp.CollisionOffsetX or 0,(bp.Physics.LayerChangeOffsetHeight + (bp.SizeY*1.0)) or 0,bp.CollisionOffsetZ or 0, bp.SizeX * scale, bp.SizeY * scale, bp.SizeZ * scale )
            ...
            self.IsWaiting = true
            WaitFor(self.AnimManip)
            self:SetCollisionShape( 'Box', bp.CollisionOffsetX or 0,(bp.Physics.CollisionOffsetY + (bp.SizeY * 0.5)) or 0,bp.CollisionOffsetZ or 0, bp.SizeX * scale, bp.SizeY * scale, bp.SizeZ * scale )
            self.IsWaiting = false
