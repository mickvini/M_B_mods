...
local BlackOpsCollisionBeamFile = import('/mods/M&B/lua/BlackOpsdefaultcollisionbeams.lua')
...
local BlackOpsEffectTemplate = import('/mods/M&B/lua/BlackOpsEffectTemplates.lua')
...
RailGunWeapon01 = Class(DefaultProjectileWeapon) {
    FxChargeMuzzleFlash = {
		'/mods/M&B/effects/emitters/x_cannon_charge_test_01_emit.bp',--#lightning
    },
    FxMuzzleFlash = {
		'/mods/M&B/effects/emitters/xcannon_cannon_muzzle_01_emit.bp',--#large redish flash
		'/mods/M&B/effects/emitters/x_cannon_fire_test_01_emit.bp',--barrel lightning effect
		'/mods/M&B/effects/emitters/jugg_rail_cannon_muzzle_07_emit.bp',-- small redish flash, double quick
		'/mods/M&B/effects/emitters/jugg_rail_cannon_muzzle_08_emit.bp',-- small redish double flash
	},
...
XCannonWeapon01 = Class(DefaultProjectileWeapon) {
    #FxChargeMuzzleFlash = {
		#'/mods/M&B/effects/emitters/xcannon_muzzle_charge_01_emit.bp',
		#'/mods/M&B/effects/emitters/xcannon_muzzle_charge_02_emit.bp',#blue glow
        #'/mods/M&B/effects/emitters/xcannon_muzzle_charge_05_emit.bp',#purple glow
    #},
    #FxMuzzleFlash = {
	#	'/mods/M&B/effects/emitters/xcannon_cannon_muzzle_01_emit.bp',--#large redish flash
	#	'/mods/M&B/effects/emitters/x_cannon_fire_test_01_emit.bp',--barrel lightning effect
	#	'/mods/M&B/effects/emitters/xcannon_cannon_muzzle_07_emit.bp',-- small redish flash, double quick
	#	'/mods/M&B/effects/emitters/xcannon_cannon_muzzle_08_emit.bp',-- small redish double flash
	#},
...
ShadowCannonWeapon01 = Class(DefaultProjectileWeapon) {
    FxChargeMuzzleFlash = {
		'/mods/M&B/effects/emitters/shadow_muzzle_charge_01_emit.bp',
		'/mods/M&B/effects/emitters/shadow_muzzle_charge_02_emit.bp',
        '/mods/M&B/effects/emitters/shadow_muzzle_charge_05_emit.bp',
        '/mods/M&B/effects/emitters/shadow_muzzle_charge_04_emit.bp',
    },
    FxMuzzleFlash = {
		'/mods/M&B/effects/emitters/shadow_cannon_muzzle_01_emit.bp',
		'/mods/M&B/effects/emitters/shadow_cannon_muzzle_02_emit.bp',
		#'/mods/M&B/effects/emitters/shadow_cannon_muzzle_03_emit.bp',
		#'/mods/M&B/effects/emitters/shadow_cannon_muzzle_04_emit.bp',
		'/mods/M&B/effects/emitters/shadow_cannon_muzzle_05_emit.bp',
		'/mods/M&B/effects/emitters/shadow_cannon_muzzle_06_emit.bp',
		'/mods/M&B/effects/emitters/shadow_cannon_muzzle_07_emit.bp',
		'/mods/M&B/effects/emitters/shadow_cannon_muzzle_08_emit.bp',
		'/mods/M&B/effects/emitters/shadow_hit_10_emit.bp',
		'/mods/M&B/effects/emitters/shadow_muzzle_flash_01_emit.bp',
		'/mods/M&B/effects/emitters/shadow_muzzle_flash_02_emit.bp',
		'/mods/M&B/effects/emitters/shadow_muzzle_flash_03_emit.bp',
	},
...
BassieCannonWeapon01 = Class(DefaultProjectileWeapon) {
    ...
    FxMuzzleFlash = {
		'/mods/M&B/effects/emitters/bassie_cannon_muzzle_01_emit.bp',
		'/mods/M&B/effects/emitters/bassie_cannon_muzzle_02_emit.bp',
		#'/mods/M&B/effects/emitters/bassie_cannon_muzzle_03_emit.bp',
		#'/mods/M&B/effects/emitters/bassie_cannon_muzzle_04_emit.bp',
		'/mods/M&B/effects/emitters/bassie_cannon_muzzle_05_emit.bp',
		'/mods/M&B/effects/emitters/bassie_cannon_muzzle_06_emit.bp',
		'/mods/M&B/effects/emitters/bassie_cannon_muzzle_07_emit.bp',
		'/mods/M&B/effects/emitters/bassie_cannon_muzzle_08_emit.bp',
		'/mods/M&B/effects/emitters/bassie_hit_10_emit.bp',
		'/mods/M&B/effects/emitters/bassie_muzzle_flash_01_emit.bp',
		'/mods/M&B/effects/emitters/bassie_muzzle_flash_02_emit.bp',
		'/mods/M&B/effects/emitters/bassie_muzzle_flash_03_emit.bp',
	},
	FxMuzzleFlashScale = 0.5,
	FxChargeMuzzleFlashScale = 1,
}
					...
					if TableSize >= 1 then	
						if TableSize == f_count then	
							...
							if not tar:BeenDestroyed() and not tar:IsDead() then
								...
								CreateAttachedEmitter(tar, 0, tar:GetArmy(), '/mods/M&B/effects/emitters/targeted_effect_01_emit.bp'):OffsetEmitter(0, 0.5,0) 
								#LOG('emit')
							end
						else 
