...
#
local TIFSmallYieldNuclearBombProjectile = import('/mods/M&B/lua/EXBlackopsprojectiles.lua').UEFACUClusterMIssileProjectile02
...
EXSmallYieldNuclearBomb01 = Class(TIFSmallYieldNuclearBombProjectile) {
    ...
    --        end
    --       
	--		nukeProjectile = self:CreateProjectile('/mods/M&B/effects/Entities/EXCluster01EffectController01/EXCluster01EffectController01_proj.bp', 0, 0, 0, nil, nil, nil):SetCollision(false)
