...
local SeraHeavyLightningCannonChildProjectile = import('/mods/M&B/lua/BlackOpsprojectiles.lua').SeraHeavyLightningCannonChildProjectile
...
SeraHeavyLightningCannonChild01 = Class(SeraHeavyLightningCannonChildProjectile) {
    ...
    AttackBeams = {'/mods/M&B/effects/emitters/seraphim_lightning_beam_02_emit.bp'},

	FxBeam = {'/mods/M&B/effects/emitters/seraphim_lightning_beam_02_emit.bp'},
	FxBeamScale = 0.01,
