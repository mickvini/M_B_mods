...
local CybranHailfire02Projectile = import('/mods/M&B/lua/BlackOpsprojectiles.lua').CybranHailfire02Projectile
   ...
   OnCreate = function(self)
    ...
    SetTurnRateByDist = function(self)
		...
		if dist > 0 and dist <= 15 then
			...
			local ChildProjectileBP = '/mods/M&B/projectiles/CybranHailfire01child/CybranHailfire01child_proj.bp'  
