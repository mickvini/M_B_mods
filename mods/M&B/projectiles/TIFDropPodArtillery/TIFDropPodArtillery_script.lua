...
local GetTerrainAngles = import('/mods/M&B/lua/TerrainUtils.lua').GetTerrainSlopeAnglesDegrees
TIFDropPodArtilleryMechMarine = Class(TArtilleryAntiMatterProjectile) {
    ...
    DropUnit = function(self)
        ...
        CreatePropHPR('/mods/M&B/env/uef/props/UEF_Ivan_Droppod_Remains_prop.bp',
