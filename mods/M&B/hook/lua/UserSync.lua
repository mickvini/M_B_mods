------------------------------------------------------------------------
--                                                                    --
-- Hook into File : /lua/UserSync.lua                                 --
-- Origin         : skuf (Economy Helper) mod, merged into M&B        --
--                                                                    --
-- Summary  : Divided-table helpers for quick "what is near this      --
--            position" lookups, plus dead-structure bookkeeping for  --
--            the deposit hover-build (a destroyed mex can be         --
--            re-clicked into a rebuild via Alt).                     --
--                                                                    --
------------------------------------------------------------------------
