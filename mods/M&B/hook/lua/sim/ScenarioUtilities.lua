...
if M28OldACreateArmyGroupAsPlatoon then
    ...
    CreateArmyGroupAsPlatoon = function(strArmy, strGroup, formation, tblNode, platoon, balance)
        ...
        ForkThread(import('/mods/M&B/lua/AI/M28Events.lua').ScenarioPlatoonCreated, oPlatoon, strArmy, strGroup, formation, tblNode, platoon, balance)
        return oPlatoon
    end
...
--if OrigInitializeSkirmishSystems then --safeGetGlobal('InitializeSkirmishSystems') then
    ...
    InitializeSkirmishSystems = function(self)
        ...
        if M28Utilities.bLoudModActive or M28Utilities.bQuietModActive then
            import('/mods/M&B/lua/AI/M28Overseer.lua').bBeginSessionTriggered = true --needed for M28 code to run and not get stuck in a loop
            ...
            if (oBrain.BrainType == 'AI' and not(ArmyIsCivilian(oBrain:GetArmyIndex()))) or (oBrain.BrainType == 'Human' and  not(tonumber(ScenarioInfo.Options.M28CombinedArmy or 2) == 2) and not(ScenarioInfo.Options.M28CombinedArmy == 4)) then
                ...
                if M28Utilities.DoesAINicknameContainM28(oBrain.Nickname) or tonumber(ScenarioInfo.Options.M28Teams) == 3 or (tonumber(ScenarioInfo.Options.M28Teams) == 2 and (iTeam <= 0 or iTeam == 1 or iTeam == 3 or iTeam == 5 or iTeam == 7)) then
                    ...
                    import('/mods/M&B/lua/AI/LOUD/M28OtherLOUDCompatibility.lua').LOUDBrainCreateStartVariables(oBrain)
        ...
        elseif M28Utilities.bSteamActive then
            ...
            import('/mods/M&B/lua/AI/Steam/SteamCompatibility.lua').OtherSteamCompatibilityInformation()
        else
