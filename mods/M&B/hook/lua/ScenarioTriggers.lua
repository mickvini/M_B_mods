...
CreateUnitCapturedTrigger = function(cbOldUnit, cbNewUnit, unit)
    ...
    ForkThread(import('/mods/M&B/lua/AI/M28Events.lua').CaptureTriggerAdded, cbOldUnit, cbNewUnit, unit)
end
...
CreateUnitDeathTrigger = function(callback, unit)
    ...
    ForkThread(import('/mods/M&B/lua/AI/M28Events.lua').DeathTriggerAdded, unit)
end
