------------------------------------------------------------------------------
-- File     :  FAF versino of /projectiles/CIFEMPFluxWarhead02/CIFEMPFluxWarhead02_script.lua
-- For      :  FAF/1.6.6 cross compatibility
------------------------------------------------------------------------------
local NullShell = import('/lua/sim/defaultprojectiles.lua').NullShell
local RandomFloat = import('/lua/utilities.lua').GetRandomFloat

CIFEMPFluxWarhead = Class(NullShell) {
    ...
    PlumeVelocityScale = 0.01,

    EffectThread = function(self)
        -- Light and Camera Shake
        CreateLightParticle(self, -1, self:GetArmy(), 60, 60, 'beam_white_01', 'ramp_red_09')
        self:ShakeCamera(125, 1, 0, 10)
