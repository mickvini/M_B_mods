...
local SDFUnstablePhasonBeam = import('/mods/M&B/lua/kirvesweapons.lua').SDFUnstablePhasonBeam
local EffectTemplate = import('/mods/M&B/lua/kirveseffects.lua')
