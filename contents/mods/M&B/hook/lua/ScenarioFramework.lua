...
function FakeGateInUnit(unit, callbackFunction)
    ...
    if EntityCategoryContains( categories.COMMAND, unit ) then
        ...
        LOG('Faction ',faction)
        if faction == 1 then
            unit:SetMesh('/mods/M&B/modAcu/eel0001/EEL0001_PhaseShield_mesh', true)
        ...
        elseif faction == 2 then
            unit:SetMesh('/mods/M&B/modAcu/eal0001/EAL0001_PhaseShield_mesh', true)
            unit:ShowBone(0, true)
        ...
        elseif faction == 3 then
            unit:SetMesh('/mods/M&B/modAcu/erl0001/ERL0001_PhaseShield_mesh', true)
            unit:ShowBone(0, true)
