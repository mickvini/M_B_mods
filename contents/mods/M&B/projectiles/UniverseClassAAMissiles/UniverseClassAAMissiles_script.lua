...
FxTrail = '/mods/M&B/effects/emitters/w_c_rkt01_p_02_glow_emit.bp',
    FxTrailOffset = 0,

        PolyTrails = {
      '/mods/M&B/effects/emitters/w_c_rkt01_p_01_polytrail_emit.bp',
      '/mods/M&B/effects/emitters/w_c_rkt01_p_07_polytrail_emit.bp',
      '/mods/M&B/effects/emitters/w_c_rkt01_p_08_polytrail_emit.bp',
      '/mods/M&B/effects/emitters/w_c_rkt01_p_09_polytrail_emit.bp',
        },
