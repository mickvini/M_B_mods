...
MartyrMicrowaveLaserCollisionBeam01 = Class(HawkCollisionBeam) {
    ...
    FxBeam = {'/mods/M&B/effects/emitters/mini_microwave_laser_beam_01_emit.bp'},
...
MiniQuantumBeamGeneratorCollisionBeam = Class(HawkCollisionBeam) {
    ...
    FxBeam = {'/mods/M&B/effects/emitters/mini_quantum_generator_beam_01_emit.bp'},
    FxBeamEndPoint = {
...
SuperQuantumBeamGeneratorCollisionBeam = Class(HawkCollisionBeam) {
    ...
    FxBeam = {'/mods/M&B/effects/emitters/super_quantum_generator_beam_01_emit.bp'},
    FxBeamEndPoint = {
		'/effects/emitters/quantum_generator_end_01_emit.bp',
        '/effects/emitters/quantum_generator_end_03_emit.bp',
        '/effects/emitters/quantum_generator_end_04_emit.bp',
...
MiniPhasonLaserCollisionBeam = Class(HawkCollisionBeam) {
    ...
    FxBeam = {'/mods/M&B/effects/emitters/mini_phason_laser_beam_01_emit.bp'},
    FxBeamStartPointScale = 0.2,
...
JuggLaserCollisionBeam = Class(HawkCollisionBeam) {
    ...
    FxBeam = {'/mods/M&B/effects/emitters/jugg_laser_beam_01_emit.bp'},
    FxBeamEndPoint = {
		'/effects/emitters/quantum_generator_end_01_emit.bp',
        '/effects/emitters/quantum_generator_end_03_emit.bp',
        '/effects/emitters/quantum_generator_end_04_emit.bp',
...
RailLaserCollisionBeam01 = Class(HawkCollisionBeam) {
    ...
    FxBeamStartPoint = EffectTemplate.CMicrowaveLaserMuzzle01,
    FxBeamStartPointScale = 0.2,
    FxBeam = {'/mods/M&B/effects/emitters/rail_microwave_laser_beam_01_emit.bp'},
    FxBeamEndPoint = EffectTemplate.CMicrowaveLaserEndPoint01,
    FxBeamEndPointScale = 0.2,
    SplatTexture = 'czar_mark01_albedo',
    ScorchSplatDropTime = 0.25,
...
TDFGoliathCollisionBeam = Class(HawkCollisionBeam) {
    ...
    TerrainImpactScale = 1,
    FxBeamEndPoint = {
		'/mods/M&B/effects/emitters/goliath_death_laser_end_01_emit.bp',			# big glow
		'/mods/M&B/effects/emitters/goliath_death_laser_end_02_emit.bp',			# random bright blueish dots
		...
		'/mods/M&B/effects/emitters/goliath_death_laser_end_06_emit.bp',			# upward sparks
		'/effects/emitters/uef_orbital_death_laser_end_07_emit.bp',			# outward line streaks
		'/mods/M&B/effects/emitters/goliath_death_laser_end_08_emit.bp',			# center glow
		'/effects/emitters/uef_orbital_death_laser_end_distort_emit.bp',	# screen distortion
	},
    FxBeamStartPointScale = 1,
    FxBeam = {'/mods/M&B/effects/emitters/goliath_death_laser_beam_01_emit.bp'},
    FxBeamStartPoint = {
		'/mods/M&B/effects/emitters/goliath_death_laser_muzzle_01_emit.bp',	# random bright blueish dots
		'/mods/M&B/effects/emitters/goliath_death_laser_muzzle_02_emit.bp',	# molecular, small details
		'/mods/M&B/effects/emitters/goliath_death_laser_muzzle_03_emit.bp',	# darkening lines
		'/mods/M&B/effects/emitters/goliath_death_laser_muzzle_04_emit.bp',	# small downward sparks
		'/mods/M&B/effects/emitters/goliath_death_laser_muzzle_05_emit.bp',	# big glow
    },
...
MGAALaserCollisionBeam = Class(HawkCollisionBeam) {
    FxBeam = {
		'/mods/M&B/effects/emitters/aa_cannon_beam_01_emit.bp',
	},
    FxBeamEndPoint = {
...
GoldenLaserCollisionBeam01 = Class(HawkCollisionBeam) {
    ...
    FxBeam = {'/mods/M&B/effects/emitters/mini_golden_laser_beam_01_emit.bp'},
