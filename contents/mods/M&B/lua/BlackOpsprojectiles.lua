...
MiniRocket03PRojectile = Class(SingleBeamProjectile) {
    ...
    BeamName = '/mods/M&B/effects/emitters/missile_munition_exhaust_beam_02_emit.bp',
...
MiniRocket04PRojectile = Class(SingleBeamProjectile) {
    ...
    BeamName = '/mods/M&B/effects/emitters/missile_munition_exhaust_beam_03_emit.bp',
...
ShadowCannonProjectile = Class(MultiPolyTrailProjectile) {
    PolyTrails = {
		--'/mods/M&B/effects/emitters/shadow_bolter_trail_01_emit.bp',
		'/mods/M&B/effects/emitters/shadowcannon_polytrail_01_emit.bp',
	},
    PolyTrailOffset = {0,0}, 
...
Juggfire01 = Class(MultiPolyTrailProjectile) {
    ...
    FxTrails = {
		'/mods/M&B/effects/emitters/Juggfire01_emit.bp',
...
NapalmProjectile01 = Class(EmitterProjectile) {
    FxTrails = {'/mods/M&B/Effects/Emitters/NapalmTrailFX.bp',},
...
MGQAIRocketChildProjectile = Class(SingleCompositeEmitterProjectile) {
    PolyTrail = '/mods/M&B/effects/emitters/mgqai_missile_trail_emit.bp',
    BeamName = '/mods/M&B/effects/emitters/mgqai_missle_exhaust_beam_01_emit.bp',
    PolyTrailOffset = -0.05,
...
MGQAIPlasmaArtyProjectile = Class(EmitterProjectile) {
    ...
    ChildProjectile = '/mods/M&B/projectiles/MGQAIPlasmaArtyChild01/MGQAIPlasmaArtyChild01_proj.bp',
...
RaiderCannonProjectile = Class(SinglePolyTrailProjectile) {
    FxTrails = {
        ...
        '/mods/M&B/effects/emitters/raider_cannon_01_emit.bp',
        '/mods/M&B/effects/emitters/raider_cannon_02_emit.bp',
    },
...
GargEMPWarheadProjectile = Class(SingleBeamProjectile) {
    ...
    OnImpact = function(self, targetType, targetEntity)
        ...
        for i = 0, (blanketSides-1) do
            local blanketX = math.sin(i*blanketAngle)
            local blanketZ = math.cos(i*blanketAngle)
            self:CreateProjectile('/mods/M&B/effects/entities/EffectEMPAmbient01/EffectEMPAmbient01_proj.bp', blanketX, 0.5, blanketZ, blanketX, 0, blanketZ)
                :SetVelocity(blanketVelocity):SetAcceleration(-0.3)
        end
